    ...
    new(Parent) :-
        ...
        addShowListener(
            {  :-
                ...
                gui_native::logfont(Height, Width, Esc, Ori, _Weight, Italic, Underline, StrikeOut, CharSet, OutPrec, ClipPrec, Qual, Pitch, Face) =
                    F1,
                F2 =
                    gui_native::logfont(Height * 3 div 2, Width, Esc, Ori, 800, Italic, Underline, StrikeOut, CharSet, OutPrec, ClipPrec, Qual,
                        Pitch, Face),
